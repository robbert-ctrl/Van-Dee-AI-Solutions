        ...
        <div className="text-center mb-12">
          <Reveal width="100%">
            ...
            <h1 className="text-3xl md:text-5xl font-display font-bold mb-4">
              Privacy<span className="text-neon-cyan">verklaring</span>
            </h1>
          ...
          <div className="glass-panel rounded-2xl border border-white/10 p-8 md:p-12 space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-400 leading-relaxed">
                <strong className="text-white">KVK nummer:</strong> 85394041
              </p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">3. Waarom hebben wij deze gegevens nodig?</h2>
              <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">4. Hoe lang bewaren wij gegevens?</h2>
              <p className="text-gray-400 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">5. Delen met derden</h2>
              <p className="text-gray-400 leading-relaxed mb-4">
                Van Dee AI Solutions verstrekt uw gegevens alleen aan derden als dit nodig is voor de uitvoering van onze diensten:
              </p>
              <ul className="space-y-2 text-gray-400 ml-6">
                <li>• <strong className="text-white">Cal.com</strong> - Voor het afspraken systeem</li>
                <li>• <strong className="text-white">E-mail service providers</strong> - Voor nieuwsbrief verzending (indien van toepassing)</li>
              </ul>
              <p className="text-gray-400 leading-relaxed mt-4">
                <strong className="text-white">Belangrijke garantie:</strong> Uw bedrijfsdata wordt NOOIT gebruikt om publieke
