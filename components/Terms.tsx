    ...
    <section className="py-20 relative bg-deep-space">
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="text-center mb-12">
          <Reveal width="100%">
            ...
            <h1 className="text-3xl md:text-5xl font-display font-bold mb-4">
              Algemene <span className="text-neon-purple">Voorwaarden</span>
            </h1>
        ...
        <Reveal delay={0.2} width="100%">
          <div className="glass-panel rounded-2xl border border-white/10 p-8 md:p-12 space-y-8">

            <section>
              <h2 className="text-2xl font-bold text-white mb-4">1. Definities</h2>
              <ul className="space-y-2 text-gray-400 ml-6">
                <li>• <strong className="text-white">Van Dee AI Solutions:</strong> Robbert van Dee, handelend onder de naam Van Dee AI Solutions, gevestigd te Tiel, Nederland. KVK nummer: 85394041.</li>
                <li>• <strong className="text-white">Klant:</strong> De partij waarmee Van Dee AI Solutions een overeenkomst aangaat.</li>
                <li>• <strong className="text-white">Diensten:</strong> Alle werkzaamheden en/of diensten die Van Dee AI Solutions uitvoert voor de Klant.</li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">3. Gratis Verkenningsgesprek</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">4. Offerte en Overeenkomst</h2>
              <p className="text-gray-400 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">5. Uitvoering Diensten</h2>
              <p className="text-gray-400 leading-relaxed mb-4">
              ...
              <p className="text-gray-400 leading-relaxed">
                <strong className="text-white">Werkend Prototype Garantie:</strong> Bij custom ontwikkeling betaalt de
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">6. Intellectueel Eigendom</h2>
              <p className="text-gray-400 leading-relaxed mb-4">
                <strong className="text-white">Code Eigendom:</strong> Na volledige betaling draagt Van Dee AI Solutions
              ...
              <p className="text-gray-400 leading-relaxed mt-4">
                <strong className="text-white">Uitzondering:</strong> Generieke herbruikbare componenten en tools die
                niet specifiek voor de Klant zijn ontwikkeld, blijven eigendom van Van Dee AI Solutions.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-white mb-4">7. Betaling</h2>
              <p className="text-gray-400 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">8. Geheimhouding</h2>
              <p className="text-gray-400 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">9. Aansprakelijkheid</h2>
              <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">10. Resultaat Garantie</h2>
              <p className="text-gray-400 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">11. Beëindiging</h2>
              <p className="text-gray-400 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">12. Toepasselijk Recht</h2>
              <p className="text-gray-400 leading-relaxed">
